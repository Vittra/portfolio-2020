...
const roleDescription = "As a newly started company everything around their webtool needed to be workshopped, created, wireframed tested, and designed. My role included UX research, workshop facilitation, and UI design."
const result = "When finished Bruger will be one of the most modern and easy-to-use products on the market for client vendors and consultants. Time reporting, matching jobs with consultant & saving hundreds of hours with reporting and communication between clients, consultants & vendors."
const descImage1 = "A huge majority of the work was done through different workshops with participants in different fields. Everyone from database experts to actual vendors partook in over 5 workshops I developed & facilitated."
const altImage1 = "Image of work I've done for Bruger"
const descImage2 = "One strength of involving so many different stakeholders was a clearer path to take when it came to interface and usability. This is reflected in all the different end results from the workshops."
